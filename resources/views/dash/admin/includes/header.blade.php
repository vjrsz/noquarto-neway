    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav d-flex align-items-center navbar-light ms-auto">
                        ...
                        @foreach ($notifications as $n)
                            <li class="list-group-item border-0 align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class='text-xs'>
                                        {{ $n->name }}, acabou de realizar um cadastro.
                                    </p>
                                </div>
            ...
            <li class="dropdown user-style">
                <a href="#" data-bs-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                    <div class="d-md-block d-lg-inline-block">olá, {{Auth::user()->name}}!</div>
                </a>
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="{{route('dashboard.admin.logout')}}"><i data-feather="log-out"></i> Sair</a>
                </div>
            </li>
        </ul>
    </div>
